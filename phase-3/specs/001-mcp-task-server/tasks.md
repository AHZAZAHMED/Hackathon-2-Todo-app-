...
- [ ] T001 Create MCP server directory structure in backend/app/mcp/
- [ ] T002 Create MCP tools directory structure in backend/app/mcp/tools/
- [ ] T003 [P] Add mcp[cli] dependency to backend/requirements.txt
- [ ] T004 [P] Create MCP server initialization file backend/app/mcp/__init__.py
- [ ] T005 [P] Create MCP tools package file backend/app/mcp/tools/__init__.py
- [ ] T006 Create MCP server startup script backend/scripts/run_mcp_server.py
...
- [ ] T007 Implement MCP server initialization in backend/app/mcp/server.py using MCPServer with stdio transport
- [ ] T008 Configure database connection pooling with pool_size=10, max_overflow=20 in backend/app/database.py
- [ ] T009 [P] Create base tool response format utilities in backend/app/mcp/utils.py
- [ ] T010 [P] Implement user_id validation helper in backend/app/mcp/utils.py
- [ ] T011 Verify existing Task model in backend/app/models/task.py supports all required operations
...
- [ ] T012 [P] [US1] Create add_task tool implementation in backend/app/mcp/tools/add_task.py
- [ ] T013 [US1] Implement input validation (user_id required, title required, title max 500 chars) in add_task
- [ ] T014 [US1] Implement database insert operation using SQLModel with user_id filtering in add_task
- [ ] T015 [US1] Implement response format (task_id, status="created", title) in add_task
- [ ] T016 [US1] Implement error handling (missing user_id, empty title, title too long, database errors) in add_task
- [ ] T017 [US1] Register add_task tool with MCP server in backend/app/mcp/server.py
...
- [ ] T021 [P] [US2] Create list_tasks tool implementation in backend/app/mcp/tools/list_tasks.py
- [ ] T022 [US2] Implement input validation (user_id required, status optional with valid values) in list_tasks
- [ ] T023 [US2] Implement pagination with limit parameter (default 100, max 1000) in list_tasks
- [ ] T024 [US2] Implement task ordering by created_at DESC (newest first) in list_tasks
- [ ] T025 [US2] Implement status filtering (all/pending/completed) using SQLModel queries in list_tasks
- [ ] T026 [US2] Implement user isolation filtering (WHERE user_id = $1) in list_tasks
- [ ] T027 [US2] Implement response format (array of task objects with all fields) in list_tasks
- [ ] T028 [US2] Implement error handling (missing user_id, invalid status, database errors) in list_tasks
- [ ] T029 [US2] Register list_tasks tool with MCP server in backend/app/mcp/server.py
...
- [ ] T035 [P] [US3] Create complete_task tool implementation in backend/app/mcp/tools/complete_task.py
- [ ] T036 [US3] Implement input validation (user_id required, task_id required) in complete_task
- [ ] T037 [US3] Implement task lookup with user isolation (WHERE id = $1 AND user_id = $2) in complete_task
- [ ] T038 [US3] Implement idempotent update (set completed=true, update updated_at) in complete_task
- [ ] T039 [US3] Implement response format (task_id, status="completed", title) in complete_task
- [ ] T040 [US3] Implement error handling (missing params, task not found, database errors) in complete_task
- [ ] T041 [US3] Register complete_task tool with MCP server in backend/app/mcp/server.py
...
- [ ] T046 [P] [US4] Create update_task tool implementation in backend/app/mcp/tools/update_task.py
- [ ] T047 [US4] Implement input validation (user_id required, task_id required, at least one field to update) in update_task
- [ ] T048 [US4] Implement task lookup with user isolation (WHERE id = $1 AND user_id = $2) in update_task
- [ ] T049 [US4] Implement partial update logic (update only provided fields: title, description) in update_task
- [ ] T050 [US4] Implement title validation (max 500 chars, not empty if provided) in update_task
- [ ] T051 [US4] Implement updated_at timestamp update in update_task
- [ ] T052 [US4] Implement response format (task_id, status="updated", title) in update_task
- [ ] T053 [US4] Implement error handling (missing params, no fields to update, task not found, title too long) in update_task
- [ ] T054 [US4] Register update_task tool with MCP server in backend/app/mcp/server.py
...
- [ ] T060 [P] [US5] Create delete_task tool implementation in backend/app/mcp/tools/delete_task.py
- [ ] T061 [US5] Implement input validation (user_id required, task_id required) in delete_task
- [ ] T062 [US5] Implement task lookup with user isolation (WHERE id = $1 AND user_id = $2) in delete_task
- [ ] T063 [US5] Capture task title before deletion for response in delete_task
- [ ] T064 [US5] Implement hard delete operation (DELETE FROM tasks WHERE...) in delete_task
- [ ] T065 [US5] Implement response format (task_id, status="deleted", title) in delete_task
- [ ] T066 [US5] Implement error handling (missing params, task not found, database errors) in delete_task
- [ ] T067 [US5] Register delete_task tool with MCP server in backend/app/mcp/server.py
