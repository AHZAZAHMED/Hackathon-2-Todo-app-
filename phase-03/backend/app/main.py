...
app = FastAPI(
    ...
    description="Authentication system with Better Auth + JWT + AI Chat for Todo Application",
    version="3.0.0",
)

# Configure timeout middleware (Phase-3: 5 second timeout for /api/chat)
...
app.include_router(chat.router)  # Phase-3: Chat endpoint
